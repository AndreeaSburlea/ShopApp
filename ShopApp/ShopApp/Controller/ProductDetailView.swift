...
class ProductDetailView: UIViewController {
    ...
    @IBAction func likeAction(sender: UIButton) { async
        {
            do {
                let name = self.product.getName()
                let indexFav = await self.getIndex()
    ...
    @IBAction func addToCart(sender: UIButton) { async
        {
            do {
                let name = self.product.getName()
                await self.setCart()
...
extension ProductDetailView: ProductImagesPageViewControllerDelegate {
