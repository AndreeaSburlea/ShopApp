...
extension ProductImagesPageViewController: UIPageViewControllerDataSource {
    func pageViewController(_ pageViewController: UIPageViewController,
        ...
        guard var index = (viewController as? ImagesProductViewController)?.getIndex() else {
    ...
    func contentViewController(at index: Int) -> ImagesProductViewController? {
        if index < 0 || index > 3 {
            return nil
        }
        ...
        if let pageContentViewController = storyboard.instantiateViewController(withIdentifier: "ImagesProductViewController") as? ImagesProductViewController {
...
extension ProductImagesPageViewController: UIPageViewControllerDelegate {
    ...
    func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool,
        ...
        if completed {
            if let contentViewController = pageViewController.viewControllers?.first as? ImagesProductViewController {
